...
at.code.addInst(PCodeInstruction.OpCode.STC,'\n');
    ...
    default:
      ...
      if (jj_2_2(2)) {
        t = jj_consume_token(ID);
fst = new Attributes(sf.GetProcedure(t));
        jj_consume_token(LPAREN);
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case LPAREN:
        case INTVAL:
        ...
        case ID:{
          expression(fst);
sf.EvaluateProcedureParameter(fst);
          label_9:
          while (true) {
            switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case COLON:{
...
sf.EvaluateChar2Int(at, aux, t); at.code.addBlock(aux.code);
    ...
    default:
      ...
      if (jj_2_4(2)) {
        t = jj_consume_token(ID);
aux = new Attributes(sf.GetFunction(t));
        jj_consume_token(LPAREN);
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case LPAREN:
        case INTVAL:
        ...
        case ID:{
          expression(aux);
sf.EvaluateFunctionParameter(aux);
          label_12:
          while (true) {
            switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case COLON:{
