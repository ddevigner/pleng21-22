...
public class ErrorSemantico {
	...
	public static void detection(BadMultipleAssignationOrderException e, Token t)
	{
		errors++;
		System.err.println(sep);
		System.err.println(error_header(t) + "invalid multiple assignation, " +
			"mismatched number of assignables and expressions.");
		System.err.println(sep);
	}
